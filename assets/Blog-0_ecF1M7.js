import{r as n,j as e,m as u}from"./index-CQLfsnbq.js";const p="8fd805a4-a4e2-417e-8d1a-a004aa665f45",f=["imrajeevnayan.hashnode.dev","solving-array-ques.hashnode.dev"],j=()=>{const[x,h]=n.useState([]),[d,c]=n.useState(!0),[i,o]=n.useState(null),g=async t=>{var a,l,m;return((m=(l=(a=(await(await fetch("https://gql.hashnode.com/",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${p}`},body:JSON.stringify({query:`
          {
            publication(host: "${t}") {
              posts(first: 10) {
                edges {
