...
const KeyboardScene = ({ maxDpr }: { maxDpr: number }) => {
  ...
  const setupScrollAnimations = (): gsap.core.Timeline[] => {
    ...
    return [
      ...
      createSectionTimeline("#experience", "experience", "about"),
      createSectionTimeline("#github", "github", "experience"),
      createSectionTimeline("#coding-profiles", "coding-profiles", "github"),
      createSectionTimeline("#architecture", "architecture", "coding-profiles"),
      createSectionTimeline("#skills", "skills", "architecture"),
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <Spline
        className="w-full h-full fixed pointer-events-auto"
        ref={splineContainer}
...
function capSplinePixelRatio(app: Application, maxDpr: number) {
  const apply = () => {
    try {
      ...
      /* internal API moved — fail silent */
    }
  };
  apply();
