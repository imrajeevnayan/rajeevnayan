...
const testimonials = [
    {
        ...
        content: "Rajeev is a dedicated developer with a keen eye for detail. His work on the hospital management system was impressive.",
        image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=150&q=80"
    },
    {
        name: "Sarah Williams",
        role: "Project Manager",
        content: "Working with Rajeev was a pleasure. He delivers high-quality code and is always ready to tackle complex problems.",
        image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80"
    },
    {
        name: "Michael Chen",
        role: "Team Lead",
        content: "An excellent problem solver. Rajeev's contributions to our backend architecture significantly improved performance.",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl shadow-lg relative border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300"
                        >
