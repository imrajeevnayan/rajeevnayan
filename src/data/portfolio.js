...
export const profile = {
    ...
    summary: "Build scalable, secure, high-performance backend systems using Java, Spring Boot, Microservices, REST APIs, SQL, Docker, and Cloud technologies.",
    bio: [
...
export const featuredProjects = [
    {
        repo: "Food-Fiesta",
        title: "Food Fiesta",
        description: "Spring Boot web application for online food ordering — browse menus, manage a cart and place orders, with an admin surface for menu and order management.",
        architecture: "Layered Spring MVC monolith: Thymeleaf view layer → REST controllers → service layer → Spring Data JPA repositories, with multithreaded order processing behind the service boundary.",
    ...
    },
    {
        ...
        description: "Full-stack enterprise financial dashboard built on Spring Boot 3 and React 19, with JWT security, PostgreSQL persistence and Redis caching.",
        architecture: "Spring Boot 3 REST backend with a stateless JWT filter chain, PostgreSQL as system of record and Redis as a read-through cache; React 19 SPA consumes the API over versioned endpoints.",
    ...
    },
    {
        ...
        description: "Comprehensive, secure backend for hospital operations built with Spring Boot 3.x — users (patients, doctors, nurses, admins), appointments and medical records.",
        architecture: "Role-partitioned domain model behind Spring Security; appointment and records modules isolated as services, containerised with Docker Compose for reproducible environments.",
    ...
    },
    {
        ...
        description: "High-performance movie ticket booking system built with Java, Spring Boot and React — premium dark-mode UI over a transactional seat-booking core.",
        architecture: "REST API backend with transactional seat-locking to prevent double booking; PostgreSQL holds shows, seats and bookings, React client renders real-time seat state.",
    ...
    },
    {
        ...
        description: "Retrieval-Augmented Generation application built with Spring AI — document ingestion, vector search and AI-powered question answering over PDFs.",
        architecture: "Ingestion pipeline chunks and embeds PDFs into pgvector; a Spring AI retriever performs semantic search and grounds the LLM response through a REST query endpoint.",
    ...
    },
    {
        ...
        description: "Spring Boot service that generates unique short links for long URLs, exposing REST APIs for creation, retrieval and redirection.",
        architecture: "Stateless REST service with a collision-safe short-code generator, persistence through Spring Data JPA and a redirect controller on the hot read path.",
...
export const caseStudies = {
    "Food-Fiesta": {
        problem: "Restaurant ordering flows break under concurrent traffic — carts drift out of sync and admins lose visibility of incoming orders.",
        solution: "A layered Spring MVC application where ordering, menu and admin concerns are isolated behind services, with multithreaded order processing so concurrent placements never block each other.",
    ...
    "Enterprise-Expense-Tracker": {
        problem: "Finance dashboards aggregate the same expensive queries on every page load, and expense data must stay scoped per role.",
        solution: "A stateless Spring Boot 3 API secured by a JWT filter chain, with PostgreSQL as system of record and Redis caching the dashboard aggregates.",
    ...
    "Hospital-Management-System": {
        problem: "Hospital data is inherently multi-tenant by role — patients, doctors, nurses and admins must never see each other's records.",
        solution: "A role-partitioned domain model where every endpoint is authorised through Spring Security, with appointments and medical records isolated as independent service modules.",
    ...
    BookMyShow: {
        ...
        solution: "Transactional seat locking inside the booking service, so reservation and payment confirmation happen inside one atomic boundary.",
    ...
    "pdf-rag-spring-ai": {
        ...
        solution: "An ingestion pipeline that chunks and embeds PDFs into pgvector, plus a retriever that grounds every model response in the retrieved passages.",
    ...
    "url-shortener-springboot": {
        ...
        solution: "A stateless REST service with a collision-safe short-code generator and a dedicated redirect controller kept off the write path.",
